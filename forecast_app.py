...
open_weather_map_API_key = "2f4492d20d26ca9aab07eae34ba00444"
...
def thread_for_weather_maps(locations):
 ...
 #           folium.TileLayer('cartodbpositron').add_to(maps)
            ...
            maps.save("./"+city+"_"+last_timestamp_date.replace(":","_")+".html")
...
#        folium.TileLayer('cartodbdark_matter').add_to(maps)
        ...
        legend_html =   '''
                ...
                ''' %(icon_url,weather)
        maps.get_root().html.add_child(folium.Element(legend_html))        
        maps.save("./"+city+"_"+last_timestamp_date.replace(":","_")+"_latest_weather.html")
